...
public class APNMessageHandler {
	/*
	 * Cdf5335b17a5af6f50a33e6a4ee447b4a Banter: Cdf5335b17a5af6f50a33e6a4ee447b4a
	...
	@Getter
	private final TextMessageContent content;
	@Getter
	@NonNull
	...
	@Getter
	@NonNull
	private final String[] cargs;

	private static final int HM_USER_NUMBER_SAVE = 6;
	@Getter
	@NonNull
	private final static HashMap<String, String[]> hm_userid = new HashMap<String, String[]>();
	...
	public static final String[][] alias = new String[][] { { "materials", "mats", "build", "-m", "-b" },
			...
			{ "icard", "-ic" },{ "ideck", "-id" }, { "imaterials", "-im" }, { "next", "spoiler", "spoilers" }, { "inext", "-in" },
	...
	public String[] getRecentGroupIds() {
		return getRecentGroupIds(getSenderId());
	}
